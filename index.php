                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Simplify your property sale with direct listings, maximum visibility, and secure transactions on Property-Pro.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Effortlessly list your rental properties, attract tenants, and ensure smooth transactions with Property-Pro.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Easily list your property, reach potential buyers or renters, and manage your listings on Property-Pro.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Ensure secure and compliant real estate investments with Property-Pro's expert legal support.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-6 col-lg-4"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                ...
                                                <div class="price text-primary"><b>Nrs.<?php echo $row['13'];?> </b><span class="text-white"><?php echo $row['12'];?> Sqft</span></div>
                                            </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Highly rated for exceptional service, user-friendly interface, and unmatched customer satisfaction.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Decades of industry experience ensure top-quality service and reliable real estate solutions.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our seasoned agents provide expert guidance and personalized support throughout your real estate journey.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Begin with a detailed consultation to thoroughly understand your real estate objectives, preferences, and budget, ensuring a personalized approach to meet your needs.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Our team meticulously reviews all relevant documents, including contracts, disclosures, and financials, to ensure accuracy, transparency, and compliance with legal requirements.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Complete the acquisition process with confidence, securing your desired property through a seamless transaction, supported by our professional guidance and expertise.</p>
                        </div>
                    </div>
                </div>
            </div>
